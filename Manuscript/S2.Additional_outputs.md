...
scale and then logistic transformed for display on a \[0 − 1\] scale.
The light violet ridges show the distribution of the still unlabelled
records.  
...
negative records are shown. The zone included between these two
boundaries defines the uncertainty zone; records whose 98% PrI
intersects this zone requires manual review.  
...
|:---------------------------------------------------------------------------------------------|:----------------|:-----------------|:-----------------|:------------|:-----------|:---------------------|:---------------------|:---------------------|:-----------|:------------------------------|:----------------------------------|
| 1\. Mult = 10,20 & Mods = 10,20,40,60 & Resamp = n & Init = 100,250 (0.64)                   | 6               | 75 / 82          | 283 / 1200       | 91.5%       | 76.4%      | 0.699                | 60                   | 80                   | n          | 100                           | 20                                |
| 2\. Mult = 10,20 & Mods = 10,20,40,60 & Resamp = y & Init = 250,500 & Mods = 20,40,60 (0.56) | 6               | 76 / 82          | 354 / 1200       | 92.7%       | 70.5%      | 0.653                | 60                   | 90                   | y          | 250                           | 20                                |
| 3\. Mult = 10,20 & Mods = 10,20,40,60 & Resamp = n & Init = 50,500 (0.5)                     | 7               | 79 / 82          | 527 / 1200       | 96.3%       | 56.1%      | 0.54                 | 10                   | 80                   | n          | 500                           | 20                                |
| 4\. Mult = 10,20 & Mods = 1,5 & Resamp = n & Mods = 5 (0.47)                                 | 7               | 74 / 82          | 338 / 1200       | 90.2%       | 71.8%      | 0.648                | 5                    | 80                   | n          | 250                           | 20                                |
| 5\. Mult = 10,20 & Mods = 10,20,40,60 & Resamp = y & Init = 250,500 & Mods = 10 (0.39)       | 5               | 81 / 82          | 637 / 1200       | 98.8%       | 46.9%      | 0.463                | 10                   | 90                   | y          | 250                           | 20                                |
| 6\. Mult = 10,20 & Mods = 1,5 & Resamp = n & Mods = 1 & Init = 250,500 (0.31)                | 7               | 81 / 82          | 627 / 1200       | 98.8%       | 47.8%      | 0.472                | 1                    | 80                   | n          | 250                           | 20                                |
| 7\. Mult = 10,20 & Mods = 10,20,40,60 & Resamp = y & Init = 50,100 (0.23)                    | 6               | 79 / 82          | 491 / 1200       | 96.3%       | 59.1%      | 0.569                | 40                   | 80                   | y          | 100                           | 10                                |
| 8\. Mult = 1 & Init = 250,500 & Mods = 20,40,60 (0.21)                                       | 5               | 81 / 82          | 746 / 1200       | 98.8%       | 37.8%      | 0.374                | 60                   | 80                   | y          | 500                           | 1                                 |
| 9\. Mult = 10,20 & Mods = 1,5 & Resamp = n & Mods = 1 & Init = 50,100 (0.078)                | 5               | 81 / 82          | 846 / 1200       | 98.8%       | 29.5%      | 0.291                | 1                    | 80                   | n          | 100                           | 20                                |
| 10\. Mult = 10,20 & Mods = 1,5 & Resamp = y (0.054)                                          | 5               | 82 / 82          | 832 / 1200       | 100%        | 30.7%      | 0.307                | 5                    | 80                   | y          | 250                           | 20                                |
| 11\. Mult = 1 & Init = 250,500 & Mods = 1,5,10 (0.025)                                       | 5               | 82 / 82          | 981 / 1200       | 100%        | 18.2%      | 0.182                | 10                   | 90                   | y          | 500                           | 1                                 |
