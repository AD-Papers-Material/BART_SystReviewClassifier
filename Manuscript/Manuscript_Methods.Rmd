...
See Supplemental Material S1 for the combinations of hyperparameter used and other details on the method.\
...
We then identified homogeneous "performance clusters" of scores given hyperparameter values using a partition tree.
