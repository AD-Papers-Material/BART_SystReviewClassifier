...
including results between 2010 and 2020 (included). The automatic search tools were used for MEDLINE, WOS and IEEE, while a manual search and importation was necessary for EMBASE and SCOPUS. The search was repeated manually also for MEDLINE, since, as reported in the methods, the web interface may return different results from the API.
